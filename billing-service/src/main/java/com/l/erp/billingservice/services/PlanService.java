...
public class PlanService {
    ...
    public Plan createPlan(PlanRequest req, String actorId, String tenantId) {
        ...
        kafkaProducer.sendAuditEvent("CREATE_PLAN", toUUID(actorId), "PLAN", saved.getId(), Constants.SUCCESS,
    ...
    public Plan updatePlan(UUID id, PlanRequest req, String actorId, String tenantId) {
        ...
        Plan saved = planRepository.save(plan);
        kafkaProducer.sendAuditEvent("UPDATE_PLAN", toUUID(actorId), "PLAN", saved.getId(), Constants.SUCCESS,
                "{\"name\":\"" + saved.getName() + "\"}", toUUID(tenantId));
        return saved;
    }
    ...
    public Plan toggleActive(UUID id, String actorId, String tenantId) {
        ...
        kafkaProducer.sendAuditEvent(action, toUUID(actorId), "PLAN", saved.getId(), Constants.SUCCESS, null, toUUID(tenantId));
        return saved;
    }
